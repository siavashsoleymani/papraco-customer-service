          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('factureType')}>
                  Facture Type <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('agreed')}>
                  Agreed <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('notification')}>
                  Notification <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('checkedout')}>
                  Checkedout <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {factureList.map((facture, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{facture.title}</td>
                  <td>{facture.factureType}</td>
                  <td>{facture.agreed ? 'true' : 'false'}</td>
                  <td>{facture.notification}</td>
                  <td>{facture.checkedout ? 'true' : 'false'}</td>
                  <td>{facture.company ? <Link to={`company/${facture.company.id}`}>{facture.company.id}</Link> : ''}</td>
