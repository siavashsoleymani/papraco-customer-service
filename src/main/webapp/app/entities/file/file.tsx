              ...
              {fileList.map((file, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {file.file ? (
                      <div>
                        {file.fileContentType ? <a onClick={openFile(file.fileContentType, file.file)}>Open &nbsp;</a> : null}
                        <span>
                  ...
                  <td>{file.staff ? <Link to={`staff/${file.staff.id}`}>{file.staff.id}</Link> : ''}</td>
                  <td>{file.offer ? <Link to={`offer/${file.offer.id}`}>{file.offer.id}</Link> : ''}</td>
                  <td>{file.product ? <Link to={`product/${file.product.id}`}>{file.product.id}</Link> : ''}</td>
