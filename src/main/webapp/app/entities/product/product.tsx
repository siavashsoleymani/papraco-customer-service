          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('productKind')}>
                  Product Kind <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('remainCount')}>
                  Remain Count <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('reservedCount')}>
                  Reserved Count <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('boughtCost')}>
                  Bought Cost <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('boughtAt')}>
                  Bought At <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('factureNumber')}>
                  Facture Number <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('description')}>
                  Description <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('productOrigin')}>
                  Product Origin <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {productList.map((product, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{product.remainCount}</td>
                  <td>{product.reservedCount}</td>
                  <td>{product.boughtCost}</td>
                  <td>{product.boughtAt ? <TextFormat type="date" value={product.boughtAt} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{product.factureNumber}</td>
