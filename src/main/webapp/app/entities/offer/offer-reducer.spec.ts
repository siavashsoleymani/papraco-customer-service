...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_OFFER),
          REQUEST(ACTION_TYPES.UPDATE_OFFER),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_OFFER),
          REQUEST(ACTION_TYPES.DELETE_OFFER),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_OFFER),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_OFFER actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_OFFER),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_OFFER),
          payload: resolvedObject,
        },
      ];
