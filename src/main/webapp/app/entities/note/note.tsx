...
export const Note = (props: INoteProps) => {
  ...
  const { noteList, match, loading, totalItems } = props;
  return (
    <div>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  Staff <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {noteList.map((note, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{note.note}</td>
                  <td>{note.staff ? <Link to={`staff/${note.staff.id}`}>{note.staff.id}</Link> : ''}</td>
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${note.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${note.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
