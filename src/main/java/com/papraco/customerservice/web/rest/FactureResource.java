...
/**
 * REST controller for managing {@link com.papraco.customerservice.domain.Facture}.
 */
@RestController
@RequestMapping("/api")
public class FactureResource {
    ...
    public ResponseEntity<FactureDTO> updateFacture(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, factureDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<FactureDTO> partialUpdateFacture(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, factureDTO.getId())
        );
    }
