...
/**
 * REST controller for managing {@link com.papraco.customerservice.domain.File}.
 */
@RestController
@RequestMapping("/api")
public class FileResource {
     ...
     */
    @PutMapping("/files/{id}")
    public ResponseEntity<FileDTO> updateFile(@PathVariable(value = "id", required = false) final String id, @RequestBody FileDTO fileDTO)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, fileDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<FileDTO> partialUpdateFile(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, fileDTO.getId())
        );
    }
