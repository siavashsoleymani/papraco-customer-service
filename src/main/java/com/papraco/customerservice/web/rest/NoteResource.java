...
/**
 * REST controller for managing {@link com.papraco.customerservice.domain.Note}.
 */
@RestController
@RequestMapping("/api")
public class NoteResource {
    ...
    public ResponseEntity<NoteDTO> updateNote(@PathVariable(value = "id", required = false) final String id, @RequestBody NoteDTO noteDTO)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, noteDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<NoteDTO> partialUpdateNote(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, noteDTO.getId())
        );
    }
