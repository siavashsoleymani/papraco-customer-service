...
/**
 * REST controller for managing {@link com.papraco.customerservice.domain.Contract}.
 */
@RestController
@RequestMapping("/api")
public class ContractResource {
    ...
    public ResponseEntity<ContractDTO> updateContract(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, contractDTO.getId()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/contracts/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<ContractDTO> partialUpdateContract(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, contractDTO.getId())
        );
    }
